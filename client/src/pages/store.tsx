    ...
    <DashboardLayout title="Buy WhatsApp Numbers">
      ...
      {showAddFundsDialog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70">
          <div className="relative w-full max-w-md bg-black border border-purple-800/30 rounded-lg shadow-xl overflow-hidden">
            <div className="p-5">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold vibrant-gradient-text">Add Funds</h3>
                <button 
              ...
              <p className="text-purple-300 mb-4">Add funds to your account to purchase WhatsApp numbers.</p>
              ...
              <div className="flex justify-end space-x-3 mt-4 pt-4 border-t border-purple-900/20">
                <Button
                  variant="outline"
                  onClick={() => setShowAddFundsDialog(false)}
                  className="border-purple-500/30 text-purple-400 hover:bg-purple-900/20 hover:text-purple-300"
